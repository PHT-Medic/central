    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'scheme', label: 'Schema', thClass: 'text-left', tdClass: 'text-left'},
...
<template>
    <div class="container">
        <h4 class="title">
            Authentifizierungs Provider <span class="sub-title">Verwaltung</span>
        </h4>
        <div class="panel-card">
            <div class="panel-card-body">
                <div class="alert alert-primary">
                    Dies ist eine Übersicht aller Authentifizierungsprovider aller Realms.
                </div>
        ...
        <b-modal
            ...
            :hide-footer="true"
        >
            <provider-form :provider-property="item" @created="handleCreated" @updated="handleUpdated"/>
        </b-modal>
    </div>
</template>
