    ...
    <div>
        ...
        <div class="form-group">
            <div class="form-group" :class="{ 'form-group-error': $v.formData.id.$error }">
                <label>ID</label>
                <input v-model="$v.formData.id.$model" type="text" name="id" class="form-control" :disabled="isEditing" placeholder="...">
            ...
            <div class="form-group" :class="{ 'form-group-error': $v.formData.name.$error }">
                <label>Name</label>
                <input v-model="$v.formData.name.$model" type="text" name="name" class="form-control" placeholder="...">
