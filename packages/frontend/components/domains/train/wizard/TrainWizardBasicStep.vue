...
<template>
    <div>
        <div
            v-if="!public_key"
            class="alert alert-danger m-b-20"
        >
            A public key must be specified in the <nuxt-link :to="'/settings/security'">
        ...
        <div
            ...
            :class="{'alert-info': !train.type, 'alert-warning': train.type}"
        >
        ...
        >
            ...
            >
                <b-tab
                    title="Discovery"
                    :active="isDiscoveryTrain"
                    @click="setTrainType(trainType.DISCOVERY)"
                >
                    <b-card-text>
                ...
                <b-tab
                    title="Analyse"
                    :active="isAnalyseTrain"
                    @click="setTrainType(trainType.ANALYSE)"
                >
                    <b-card-text>
