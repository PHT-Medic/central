<!--
  ...
  -->
<script>
import {getRealms} from "@personalhealthtrain/ui-common";
    ...
    methods: {
        async load() {
            ...
            try {
                ...
                const response = await getRealms(data);
                ...
                <div class="ml-auto">
                    <slot name="header-actions" v-bind:load="load" v-bind:busy="busy">
                        <div class="d-flex flex-row">
                            ...
                            <div class="ml-2">
                                <nuxt-link to="/admin/realms/add" type="button" class="btn btn-xs btn-success">
