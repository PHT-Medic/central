...
describe('src/domains/train-builder', () => {
    ...
    it('should build train message', async () => {
        ...
        expect(trainMessage.userId).toEqual(user.id);
        expect(trainMessage.userRSASecretId).toEqual(userRsaSecret.id);
        expect(trainMessage.userPaillierSecretId).toEqual(userPaillierSecret.id);
        ...
        expect(trainMessage.entrypointCommandArguments).toEqual([]);
        expect(trainMessage.entrypointPath).toEqual(path.join(trainFile.directory, trainFile.name));
        expect(trainMessage.masterImage).toEqual(masterImage.virtual_path);
